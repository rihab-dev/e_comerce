...
<nav class="navbar navbar-expand-lg bg-primary" data-bs-theme="dark">
  <div class="container-fluid">
    <a class="navbar-brand" href="#">E_comerce</a>
    ...
    <div class="navbar-collapse collapse show" id="navbarColor01" >
      <ul class="navbar-nav me-auto">
        <li class="nav-item">
          <a class="nav-link active" href="index.php">Nos produit
      ...
      <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link" href="#"><i class="fas fa-user-plus"></i>Crée un Compte</a>
